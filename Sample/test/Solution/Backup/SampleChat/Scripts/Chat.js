...
Codeproject.Chat.CheckMessages = function ()
{
	...
	//Calls the web service
	SampleChat.Chat.Services.ChatService.CheckMessages(Codeproject.Chat.LastMessageId, Codeproject.Chat.CheckMessagesCallback);
...
Codeproject.Chat.SendMessage = function ()
{
	...
	if (message.trim() != "")
	{
		SampleChat.Chat.Services.ChatService.SendMessage(message, Codeproject.Chat.LastMessageId, Codeproject.Chat.CheckMessagesCallback);
		Codeproject.Chat.MessageTextbox.focus();
		Codeproject.Chat.MessageTextbox.value = "";
	}
}
