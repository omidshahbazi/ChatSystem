<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Chat.ascx.cs" Inherits="SampleChat.Chat.Controls.Chat" %>
...
<div id="chatPanel">
	...
	<div id="chatFooter">
		<input type="text" id="txtMessage" onkeypress="Codeproject.Chat.CheckSend(event);" />
