...
namespace BinarySoftCo.Tools.Barcode
{
    public class BarcodeScaner
    {
        ...
        /// <param name="NumberScans">Number of passes that must be made over the page. 
        /// 50 - 100 usually gives a good result.</param>
        public static void FullScanPage(ref ArrayList CodesRead, Bitmap bmp, int NumberScans)
        {
            ScanPage(ref CodesRead, bmp, NumberScans, ScanDirection.Vertical, FullScanBarcodeTypes);
            ScanPage(ref CodesRead, bmp, NumberScans, ScanDirection.Horizontal, FullScanBarcodeTypes);
        }
        ...
        public static void ScanPage(ref ArrayList CodesRead, Bitmap bmp, int numscans, ScanDirection Direction, BarcodeType Types)
        {
            int iHeight, iWidth;
