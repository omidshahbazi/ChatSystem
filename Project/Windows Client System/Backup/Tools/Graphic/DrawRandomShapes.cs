...
namespace BinarySoftCo.Tools.Graphic
{
    /// <summary>
    /// Draws random shapes on a form.
    /// </summary>
    public class DrawRandomShapes
    {
        #region Fields
        ...
        public DrawRandomShapes(Form form, ShapeType shape)
        {
            mainForm = form;
            shapeType = shape;
            Initialise();
        ...
        public DrawRandomShapes(Form form, string shape)
        {
            mainForm = form;
